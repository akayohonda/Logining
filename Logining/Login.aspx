<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Logining.Login" %>
            ...
            <asp:Table ID="Table1" runat="server" style="height: 300px; min-width: 250px; border-radius: 5px; border: solid gray 1px;">
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                        <asp:label ID="Label1" Text="Форма входа" runat="server" />
                    ...
                    <asp:TableCell ColumnSpan="2" HorizontalAlign="center">
                        <asp:Button ID="Button1" Text="Вход" runat="server" Width="150" OnClick="Button1_Click" style="margin: 10px 5px"/>
